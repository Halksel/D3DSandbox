...
void CubeApp::MakeCommand(ComPtr<ID3D12GraphicsCommandList>& command)
{
	...
	auto mtxProj = XMMatrixPerspectiveFovLH(XMConvertToRadians(45.0f + value), m_viewport.Width / m_viewport.Height, 0.1f, 100.0f);
